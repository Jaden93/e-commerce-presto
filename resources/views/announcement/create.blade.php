            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="bg-main card-body" style="border-radius: 10px 10px 10px 10px;">
                        ...
                        <form method="POST" action="{{route('announcement.store')}}" class="form-signin ">
                            ...
                            <div class="form-label-group">
                                ...
                                <textarea name="description" type="text" id="descrizione" class="form-control"
                                    autofocus></textarea>
                    ...
                    <label class="custom-control-label" for="customCheck1">Remember password</label>
                            ...
                            <button class="btn btn-lg custom-btn btn-block text-uppercase" type="submit">Inserisci
                                l'annuncio</button>
